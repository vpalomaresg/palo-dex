...
const typeSelectorItems: selectorItem<PokemonType>[] = [
  ...
  { label: "Fuego", value: PokemonType.Fuego },
  { label: "Agua", value: PokemonType.Agua },
  { label: "Eléctrico", value: PokemonType.Eléctrico },
  { label: "Planta", value: PokemonType.Planta },
  { label: "Hielo", value: PokemonType.Hielo },
  { label: "Lucha", value: PokemonType.Lucha },
  { label: "Veneno", value: PokemonType.Veneno },
  { label: "Tierra", value: PokemonType.Tierra },
  { label: "Volador", value: PokemonType.Volador },
  { label: "Psíquico", value: PokemonType.Psíquico },
  { label: "Bicho", value: PokemonType.Bicho },
  { label: "Roca", value: PokemonType.Roca },
  { label: "Fantasma", value: PokemonType.Fantasma },
  { label: "Dragón", value: PokemonType.Dragón },
  { label: "Siniestro", value: PokemonType.Siniestro },
  { label: "Acero", value: PokemonType.Acero },
