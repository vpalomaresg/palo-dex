...
const run = async () => {
  ...
  for (const i in extractData) {
    ...
    pokemon.spriteUrl = `https://raw.githubusercontent.com/vpalomaresg/sprites/refs/heads/main/sprites/front/${pokemon.pokeapiId}.png`;
    pokemon.shinySpriteUrl = `https://raw.githubusercontent.com/vpalomaresg/sprites/refs/heads/main/sprites/front_shiny/${pokemon.pokeapiId}.png`;
